...
const ADDED_KEY_PATHS = [
    ...
    'worker_application_details.steps.details',
    'worker_application_details.steps.documents',
    'worker_application_details.steps.review',
    'worker_application_details.steps.aria_label',
    'worker_application_details.steps.step_label',
    'worker_application_details.steps.completed',
    'worker_application_details.hints.details',
    'worker_application_details.hints.documents',
    ...
    'worker_application_details.prefilled_hint',
    'worker_application_details.cert_question',
    'worker_application_details.cert_use_vault',
    'worker_application_details.cert_upload_new',
    'worker_application_details.cert_unverified_note',
    'worker_application_details.cert_from_vault',
    'worker_job_detail.apply_flow.submit',
    'worker_application_details.errors.required_questions',
    'worker_application_details.errors.required_doc',
    'worker_application_details.errors.required_cert',
    'worker_application_details.errors.cert_proof',
