 ...
 * email_outbox.ses_message_id (migration 090) and is the ONLY key an SES
...
/**
 * The `headers` JSONB bag (migration 090). Deliberately narrow: producers put
 ...
 * bag. Migration 090's CHECK already guarantees an object or NULL, but this is
